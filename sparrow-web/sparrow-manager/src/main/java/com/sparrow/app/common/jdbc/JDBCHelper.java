package com.sparrow.app.common.jdbc;

import com.sparrow.app.common.table.TbColumn;
...
public class JDBCHelper {
    ...
    public static final String STING = "string";
    ...
    public static List<TbColumn> getPrimaryKeyColumns(Connection c,
        ...
        try {
            ...
            TbColumn pkColumn;
            while (rs.next()) {
                tmp = getTableColumns(c, catalog, schema, table,
                        rs.getString(4));
                pkColumn = tmp.get(0);
    ...
    public static String getSimpleType(int sqlType, int columnSize,
                                       int decimalDigits) {
        String rv = STING;
