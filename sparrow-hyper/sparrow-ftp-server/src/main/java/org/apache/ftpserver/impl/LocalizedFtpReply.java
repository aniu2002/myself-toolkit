...
public class LocalizedFtpReply extends DefaultFtpReply {
	...
	public static LocalizedFtpReply translate(FtpIoSession session,
	...
	public static DefaultFtpReply translateUdp(FtpIoSession session,
			FtpRequest request, FtpServerContext context, int code,
			String subId, String basicMsg, int activePort) {
		String msg = translateMessage(session, request, context, code, subId,
				basicMsg);

		return new UdpReply(code, msg, activePort);
	}
