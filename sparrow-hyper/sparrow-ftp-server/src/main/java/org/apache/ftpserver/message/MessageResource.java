...
/**
 * This is services resource interface.
 *
...
public interface MessageResource {
    ...
    /**
     * Get the services for the corresponding code and sub id. If not found it
     * will return null.
     * @param code The reply code
     * @param subId The sub ID
     * @param language The language
     * @return The services matching the provided inputs, or null if not found
     */
