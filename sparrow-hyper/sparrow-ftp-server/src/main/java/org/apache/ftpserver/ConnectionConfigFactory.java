...
public class ConnectionConfigFactory {
	...
	private int maxLogins = Integer.valueOf(System.getProperty(
			FtpConstants.MaxUser_Key, "10"));
	...
	/**
	 * Create a connection configuration instances based on the configuration on
	 * this factory
	 * 
	...
	/**
	 * Set the delay in number of milliseconds between login failures. Important
