...
('F651', 'Catalog title qualifiers', '', '', 'YES', NULL, ''),
...
('S027', 'Create method by specific method title', '', '', 'NO', NULL, ''),
...
('S071', 'SQL paths in function and type title resolution', '', '', 'YES', NULL, ''),
...
( 10004, 'COLLATING SEQUENCE', NULL, 'English', 'CHAR: default collation title' ),
...
( 2, 'DATA SOURCE NAME', NULL, '', 'CHAR: <connection title> on CONNECT statement' ),
...
( 13, 'SERVER NAME', NULL, '', 'CHAR: <SQL server title> on CONNECT statement' ),
