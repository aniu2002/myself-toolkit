    ...
    public void step() {
        ...
        try {
            ...
            if (read > 0)
                ...
                controller.close(Library.CLOSURE);
        } catch (IOException exception) {
            controller.close(exception.getMessage());
        }
    ...
    public void getChunks() {
        ...
        do {
            ...
            if (buffer.hasRemaining()) {
                ...
                // 2 bit begin, description header size
                headerSize = headerSizes[(headerFlag & 0xC0) >> 6];
                // channel description by the last 6 bits of the first byte
                            ...
                            if (packet.bodyLeft == 0) {
                                ...
                                if (packet.bodyType == 0x01) {
                                    ...
                                    switch (packet.bodyType) {
                                        ...
                                        case 0x08:
                                        case 0x09:
                                            flvList.add(newPacket);
                                            break;
                                        default:
                                            dataList.add(newPacket);
                                            break;
