...
import com.au.bootstrap.util.PropertiesFileUtil;
 ...
 * @version 20080315
 * 
 *          Tasks of Library - Hold constants
 * 
 */
...
//	private static final Properties props;
	...
	// PINGTIMEOUT - how long should the server wait for pong before
	// disconnection
	...
	public static String NOAPPS = "Directory '" + CUSTOMDIR
			+ "' doesn't exist.";
	...
	// MACPLAYERARR - connection info object values for mac player, tcUrl must
	// contain rtmp:// for fms connection
	...
	public static String[] CONNECTKEYS = { "app", "fpad", "tcUrl", "swfUrl",
			"flashVer", "capabilities", "videoCodecs", "audioCodecs",
			"videoFunction", "pageUrl", "objectEncoding" };
	public static Object[] MACPLAYERARR = { "", false, "",
			"file:///Volumes/Player.swf", "MAC 9,0,124,0", (double) 1,
			(double) 124, (double) 615, (double) 1,
			"file:///Volumes/Player.swf", (double) 0 };

	// other status objects

	public static String[] STATUSKEYS = { "level", "code", "description",
			"clientid", "details" };
	public static Object[] SUCCESSARR = { "status", SUCCESS,
			"Connection succeeded.", null, null };
	public static Object[] FAILUREARR = { "status", FAILURE,
			"Connection failed.", null, null };
	public static Object[] CLOSUREARR = { "status", CLOSURE,
			"Connection rejected.", null, null };
	public static Object[] REJECTIONARR = { "status", REJECTION,
			"Connection rejected.", null, null };
	public static Object[] AMFERRORARR = { "error", "AMF.Decode.Error", "",
			null, null };

	public static Object[] SEEKARR = { "status", SEEK, "Seeking ", null, null };
	public static Object[] PLAYSTOPARR = { "status", PLAYSTOP,
			"Stopped playing ", null, null };
	public static Object[] PLAYRESETARR = { "status", PLAYRESET,
			"Playing and resetting ", null, null };
	public static Object[] PLAYSTARTARR = { "status", PLAYSTART,
			"Started playing ", null, null };
	public static Object[] PLAYFAILEDARR = { "error", PLAYFAILED,
			"Read access denied for stream ", null, null };
	public static Object[] PUBLISHSTARTARR = { "status", PUBLISHSTART,
			" is now published.", null, null };
	public static Object[] PUBLISHBADNAMEARR = { "status", PUBLISHSTART,
			" is now published.", null, null };
	public static Object[] RECORDNOACCESSARR = { "error", RECORDNOACCESS,
			"Write access denied for stream ", null, null };
	public static Object[] UNPUBLISHSUCCESSARR = { "status", UNPUBLISHSUCCESS,
			" is now unpublished.", null, null };

//	static {
//		props = PropertiesFileUtil.getProperties("config/setting.prop");
//		STREAMDIR = props.getProperty("STREAM_PATH");
//		debug = "true".equals(props.getProperty("debug_enable"));
//		CUSTOMDIR = props.getProperty("applications_dir", "applications");
//	}
