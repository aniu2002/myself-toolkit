...
public class BeansFactory {
    ...
    private void initJedisTemplate() {
        ...
        String host = SearchConfig.get("redis.recommend.host");
        Integer port = SearchConfig.getInt("redis.recommend.port");
        Integer timeout = SearchConfig.getInt("redis.recommend.timeout");
        Integer threadCount = SearchConfig.getInt("redis.recommend.thread.count");
