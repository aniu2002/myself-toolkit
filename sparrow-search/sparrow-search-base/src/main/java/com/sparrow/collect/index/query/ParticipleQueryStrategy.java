...
import com.sparrow.collect.index.config.FieldMeta;
 ...
 */
public class ParticipleQueryStrategy implements QueryStrategy {
    ...
    public ParticipleQueryStrategy(String fieldName, String value) {
