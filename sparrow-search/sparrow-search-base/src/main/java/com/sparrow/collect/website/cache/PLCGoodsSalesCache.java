 ...
 */
public class PLCGoodsSalesCache implements ExternalDataSource<Long, Integer> {
    private Log log = LogFactory.getLog(PLCGoodsSalesCache.class);

    private MSBean<GoodsSalesCacheSupport> cacheMSBean = new MSBean<>();

    private ReentrantReadWriteLock rwLock = new ReentrantReadWriteLock();

    private static String goodsSalesKeyPrefix = "pocp_prifex_";

    public PLCGoodsSalesCache() {
    ...
    private class GoodsSalesCacheSupport implements ExternalDataSource<Long, Integer> {
        ...
        public GoodsSalesCacheSupport() {
            jedisTemplate = BeansFactory.getInstance().getPlcJedisTemplate();
        }
        ...
        public void init() {
            ...
            jedisTemplate.execute(new JedisTemplate.JedisActionNoResult() {
                ...
                public void action(Jedis jedis) {
                    ...
                    log.info("init plc goods sales count = " + count);
                }
            });
