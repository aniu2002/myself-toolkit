...
/**
 * <B>Description</B>分词策略 <br />
 * <B>Copyright</B> Copyright (c) 2014 www.diligrp.com All rights reserved. <br />
 * 本软件源代码版权归地利集团,未经许可不得任意复制与传播.<br />
 * <B>Company</B> 地利集团
 *
 * @author zhanglin
 * @createTime 2014年6月19日 下午8:02:29
 */
public class ParticipleStrategy implements IStrategy {
    ...
    public void parse(StrategyDefinition strategyBean, BooleanQuery bq)
        ...
        if (null != splitStrList) {
            ...
            for (String str : splitStrList) {
                ...
                bqTmp.add(termQuery, strategyBean.getInnerOccur());
            }
