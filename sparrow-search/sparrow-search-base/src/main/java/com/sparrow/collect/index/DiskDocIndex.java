...
import com.sparrow.collect.utils.CloseUtil;
...
public class DiskDocIndex extends DocIndex {

    Log log = LogFactory.getLog(DiskDocIndex.class);
    ...
    public DiskDocIndex(Properties config, MSBean<Directory> directory,
    ...
    public DiskDocIndex(Properties config, SpaceType type,
...
//        CloseUtil.closeQuietly(reader.getSlave());
    ...
    public void initIndexSpacer(String searchID, Properties config) {
        ...
        setConfig(config);
        this.spaceType = DocIndex.SpaceType.DISK;
        dirPath = pathMsBean;
