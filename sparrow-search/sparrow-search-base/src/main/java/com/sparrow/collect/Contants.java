...
public class Contants {
    ...
    /**
     * searcher.basesearch.$name.index.remote
     */
    ...
    /**
     * searcher.basesearch.$name.index.merge
     */
    public static final String SEARCH_INDEX_MERGE_OBJECT="index.merge";
    
    /**
     * searcher.basesearch.#name.ifield.$fieldName.analy.name
     */
    public static final String INDEX_FIELD_ANALYSI_NAME = "analy.name";
    
    /**
     * searcher.basesearch.$name.index.rtodoc.parser
     */
   ...
   public static final String SEARCH_INDEX_FIELD_PARSE_LIST=SEARCH_INDEX_FIELD_PARSE_PREFIX + ".list";
    ...
    /**
     * searcher.basesearch.#name.ifield.strategy.#
     */
   ...
   public static final String STRING_PROCESS_TAG = "string.process";
    ...
    /**
     * searcher.basesearch.name.list
     */
    public static final String SEARCH_LIST_TAG = SEARCH_PREFIX
            + ".name.list";

    /**
     * searcher.basesearch.#name.ifield.list
     */
    ...
    /**
     * searcher.basesearch.#name.ifield.#ifieldName.clas
     */
    ...
    /**
     * searcher.basesearch.$name.record.config.path
     */
    public static final String SEARCH_RECORD_CONFIG_PATH="record.config.path";
    
    /**
     * searcher.basesearch.$name.record.data.parser.cla
     */
