...
public abstract class DocIndex {
    ...
    Log log = LogFactory.getLog(DocIndex.class);

    public enum SpaceType {
        RAM, DISK, REMOTE, RAMDISK
    }

    public DocIndex(Properties config, SpaceType type,
    ...
    public DocIndex(Properties config, MSBean<Directory> directory,
    ...
    public void initDirectory() {
        ...
        try {
            MSBean<Directory> msBean = new MSBean (new MMapDirectory(
