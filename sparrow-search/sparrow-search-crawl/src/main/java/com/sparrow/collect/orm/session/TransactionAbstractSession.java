 ...
 * Time: 15:26
 */
public class TransactionAbstractSession extends DefaultAbstractSession {

    public TransactionAbstractSession(JDBCConnectionFactory connectionFactory, MapConfig mapConfig) {
