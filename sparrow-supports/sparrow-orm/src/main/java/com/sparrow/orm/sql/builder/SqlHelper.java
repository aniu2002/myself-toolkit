...
public class SqlHelper {
    ...
    public static QueSqlBuilder querySql(String sql) {
        QueSqlBuilder builder = new QueSqlBuilder(sql);
        return builder;
    }
	...
	public static SqlQueryBuilder count(String table) {
		SqlQueryBuilder builder = new SqlQueryBuilder();
		builder.select("COUNT(1)").from(table);
		return builder;
	}
