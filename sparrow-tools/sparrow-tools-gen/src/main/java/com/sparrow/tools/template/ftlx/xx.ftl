...
public class ${serviceName}Impl implements ${serviceName} {
    ...
    public int save${pojoClassName}(${pojoClassName}Dto ${regularPojoName}) throws Exception {
        if (${regularPojoName} == null)
            return 0;
        return this.${regularPojoName}Mapper.insert(this.dto2pojo(${regularPojoName}));
    }
