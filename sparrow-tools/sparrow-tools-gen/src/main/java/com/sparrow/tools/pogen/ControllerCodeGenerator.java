...
public class ControllerCodeGenerator {
    ...
    public static void doGenerate(Properties properties, Properties moduleSet,
        ...
        ControllerCodeGenerator poGenerateUtil = new ControllerCodeGenerator();
    ...
    public void execute() throws Exception {
        ...
        dm.setFilters(new TableFilters() {
            public boolean filter(String table) {
                return ControllerCodeGenerator.this.check(table);
            }
        });
