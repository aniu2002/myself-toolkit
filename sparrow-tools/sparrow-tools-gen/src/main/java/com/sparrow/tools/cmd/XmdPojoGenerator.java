...
public class XmdPojoGenerator {
	...
	public XmdPojoGenerator() {
		this(new DefaultLog());
	}

	public XmdPojoGenerator(Log log) {
	...
	public static void doGenerate(Properties properties, Properties moduleSet,
		...
		XmdPojoGenerator poGenerateUtil = new XmdPojoGenerator();
	...
	public void execute() throws Exception {
		...
		dm.setFilters(new TableFilters() {
			public boolean filter(String table) {
				return XmdPojoGenerator.this.check(table);
			}
		});
		dm.checkDatabase();
		...
		File moduleFile = XmdMapperGenerator.getNormalFile(basePath,
				"eggs", "mapConfig.xml");
