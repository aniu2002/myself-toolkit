    ...
    <script type="text/javascript">
        var columns=[
          ...
          {name:'op',label:'操作',width:'90',align:'left',render:function(v,data){
        	  v=data.id;
        	  var s='<a href="/rest/${subModule}/${pojo4LowerCase}/edit?_t=view&id='+v+'">编辑</a>&nbsp;<a href="#" onclick="delRow('+v+')">删除</a>';
        	  return s;
          },noe:true}
	    ];
        var _url='/rest/${subModule}/${restRoot}';
        var _baseUrl='${appRoot}';
        var _imgRoot='${imgRoot}';
        var _UI;
       
        var rowDblClick=function(r){
        	self.location="/rest/${subModule}/${pojo4LowerCase}/edit?_t=view&id="+r._id;
        };
...
<ul class="nav nav-tabs">
	...
	<li><a href="${pojo4LowerCase}_add.html">${tableDesc?if_exists}添加</a></li>
</ul>
<div id="searchForm"> 
</div>
<div id="grid">
