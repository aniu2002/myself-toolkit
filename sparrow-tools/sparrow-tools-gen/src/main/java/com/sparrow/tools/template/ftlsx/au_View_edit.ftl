...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
		    ...
		    _dlg._redirectUrl='/app/views/${subModule}/${pojo4LowerCase}.html';
			_dlg.title='${tableDesc?if_exists}信息';
			_dlg.draw();
			Common.ajax(_url+'/'+_id, {_t:'detail'}, function(data) {
				 _dlg.render(data);
				 _dlg.endDraw();
			});
        });
...
<ul class="nav nav-tabs">
	<li><a href="/app/views/${subModule}/${pojo4LowerCase}.html">${tableDesc?if_exists}列表</a></li>
