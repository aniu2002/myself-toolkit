...
|-------------|-------------|----------------|
| ${srv.response.status}    | ${srv.response.description} successful operation |  <#if srv.response.complex><a href="#/definitions/${srv.response.ref}">${srv.response.ref}</a><#else>${srv.response.ref}<#if (srv.response.format??)> (${srv.response.format})</#if></#if>|
