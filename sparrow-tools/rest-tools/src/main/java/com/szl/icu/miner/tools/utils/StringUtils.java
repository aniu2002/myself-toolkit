...
public class StringUtils {
    ...
    public static String trimToNull(String str) {
        String ts = trim(str);
        return emptyIs(ts) ? null : ts;
    }

    public static boolean emptyIs(CharSequence cs) {
    ...
    public static String combine(String array[]) {
        return combine(array, POINT_CHAR);
    }

    public static String combine(String array[], char delimiters) {
        StringBuilder sb = new StringBuilder();
        boolean first = true;
    ...
    public static String combine(String array[], char delimiters, String... others) {
        StringBuilder sb = new StringBuilder();
        boolean first = true;
        for (int i = 0; i < array.length; i++) {
            if (first)
