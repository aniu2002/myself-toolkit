...
public class Excel2003DataWriter extends AbstractDataWriter {
    ...
    public Excel2003DataWriter(String excelFile) {
        this(new File(excelFile));
    }

    public Excel2003DataWriter(File excelFile) {
    ...
    public static void main(String args[]) {
        DataWriter dataWriter = new Excel2003DataWriter(new File("F:/test.xls"));
        try {
            dataWriter.open();
